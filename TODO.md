...
- [ ] Quanto você ganha ao ganhar de um oponente?
- [ ] Quais power-ups existem?
- [ ] Vai ter BOSS?
...
## Cartas
- [ ] 5 naipes
- [ ] Leitão, Porco, Porca, Zhu Bajie
- [ ] Exódia (naipe próprio ou cada parte é de um naipe já existente)
- [ ] Cenoura (só possui 1 no jogo, então não pode ser de nenhum naipe)
- [ ] Verso da carta
- [ ] Animação da carta virando (não sei como, pode ser só um efeito animado ou transição que vai tocar enquanto o sprite muda)
